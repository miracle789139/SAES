...
CREATE TABLE IF NOT EXISTS `s_askreport` (
  ...
  `SENDER_DP` varchar(32) DEFAULT NULL,
  `SEND_DATE` datetime DEFAULT NULL,
  `ASKREPORT_CONTENT` varchar(50) DEFAULT NULL,
  `FILE_ID` varchar(50) DEFAULT NULL,
  `SENDDATE` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- 正在导出表  db_saes.s_askreport 的数据：0 rows
/*!40000 ALTER TABLE `s_askreport` DISABLE KEYS */;
/*!40000 ALTER TABLE `s_askreport` ENABLE KEYS */;


-- 导出  表 db_saes.s_askreport_accept 结构
CREATE TABLE IF NOT EXISTS `s_askreport_accept` (
  `ID` int(10) NOT NULL,
  `PERSON_ID` int(10) NOT NULL,
  `IS_VIEW` int(10) NOT NULL,
  `ACCEPT_DATE` datetime DEFAULT NULL,
  `CONTENT` varchar(50) DEFAULT NULL,
  `DELETEID` int(10) DEFAULT NULL,
  `ISOPEN` int(10) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- 正在导出表  db_saes.s_askreport_accept 的数据：0 rows
/*!40000 ALTER TABLE `s_askreport_accept` DISABLE KEYS */;
/*!40000 ALTER TABLE `s_askreport_accept` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `s_file` (
  ...
  `PUBLISH_DATE` datetime DEFAULT NULL COMMENT '上传日期',
  `FILE_ID` int(10) DEFAULT NULL COMMENT '附件编号',
  `NOTE` varchar(500) DEFAULT NULL COMMENT '备注',
  `FILE_TYPE_ID` int(10) DEFAULT NULL COMMENT '附件类型',
...
-- 正在导出表  db_saes.s_file 的数据：0 rows
...
CREATE TABLE IF NOT EXISTS `s_notify` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='存储通告信息';

-- 正在导出表  db_saes.s_notify 的数据：~3 rows (大约)
/*!40000 ALTER TABLE `s_notify` DISABLE KEYS */;
INSERT INTO `s_notify` (`ID`, `TITLE`, `SENDER_ID`, `SEND_DATE`, `CONTENT`, `VIEW_TIMES`, `TITLE_TOP_FLAG`, `OPERATE_TIME`, `NOTIFY_TYPE`, `FILE_ID`) VALUES
	(1, '刘延东副总理视察上海理工大学', '1', '2015-12-11 09:00:05', '12月6日，中共中央政治局委员、国务院副总理刘延东来到上海理工大学视察上海太赫兹波谱与影像技术协同创新中心建设和发展情况。中共中央政治局委员、上海市委书记韩正，教育部部长袁贵仁，国务院副秘书长江小涓，上海市副市长翁铁慧，上海市教委主任苏明等陪同视察。', 10, 1, NULL, NULL, NULL),
	(2, '关于学校2015年在职教职工体检通知\r\n', '1', '2015-12-11 09:00:49', '校内各部门：', 0, 0, NULL, NULL, NULL),
	(3, '1', '1', '2016-05-20 23:11:06', '1', 0, 1, NULL, '1', '0');
...
INSERT INTO `s_person` (`ID`, `GROUP_ID`, `PERSON_ID`, `NAME`, `ACCOUNT`, `PASSWORD`, `UNIT_ID`, `SEXID`, `ID_CARD`, `BIRTHDAY`, `SUBJECT_CLASS_ID`, `SCHOOL`, `TITLE_ID`, `EDU_LEVEL_ID`, `EDU_DEGREE_ID`, `RESEARCH_FIELD`, `NATION_ID`, `DUTY`, `DUTY_DATE`, `TUTOR_TYPE_ID`, `MOBILE`, `EMAIL`, `ADDRESS`, `POSTAL_CODE`, `TEL_OFFICE`, `FAX_OFFICE`, `TEL_HOME`, `FAX_HOME`, `PERSONAL_WEB_SITE`, `PHOTO_ID`, `WORK_DATE`, `STANDBY1`, `STANDBY2`, `STANDBY3`, `HONOR_TITLE_ID`, `EXPERT_FLAG`, `QQ`, `GRADUATE_SCHOOL`, `STATUS`, `SELF_EVA`, `WORK_EXP`, `EDU-EXP`, `PRO_SKILL`, `EELSE`, `DAOSHINAME`, `DAOSHIZHICHENG`, `DAOSHIDANWEI`) VALUES
	...
	(2, '0', '11111', '1', '1', '96e79218965eb72c92a549dd5a330112', '1', '2', NULL, NULL, '上理科室', NULL, '教授', NULL, '本科', NULL, NULL, '授课', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '/file/photo/2015123016344364882_s.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '本人性格开朗、为人诚恳、乐观向上、兴趣广泛、拥有较强的组织能力和适应能力、并具有较强的管理策划与组织管理协调能力。', '1979年9月—1983年7月：武汉大学英语系本科，获英语语言文学学士学位；1983年9月—1986年7月：首都师范大学英语系硕士研究生，获英美文学硕士学位', '研究生', '1.	全面掌握Java语言及面向对象的设计思想。', '无', NULL, NULL, NULL),
...
INSERT INTO `s_project_apply_info` (`APPLYID`, `NAME`, `PROJECT_LOCATION`, `KEY`, `SEARCH_AREAR`, `SUBJECT_CLASS`, `SEARCH_CLASS`, `PROJECT_CLASS`, `PROJECT_TYPE`, `PROJECT_SOURCE_UNIT`, `YUQI_PROJECT`, `YUQI_TIME`, `BEGIN_DATE`, `END_DATE`, `STATE`, `NOTE`, `CREATE_TIME`, `CREATOR_ID`, `CREATOR_NAME`, `REVIEWSTATE`, `REVIEWSTATE_NOTE`, `SUO_CHECK_STATE`, `SUO_CHECK_STATE_NOTE`, `YUAN_CHECK_STATE`, `YUAN_CHECK_STATE_NOTE`, `UNIT_ID`, `DIVISION_ID`, `APPLIER_ID`, `SUBJECT_ID`, `APPLY_FEE`, `APPLY_DATE`, `FILE_ID`, `IS_CONFIRM`, `BEFORE_RESEARCH_INFO`, `PROJECT_MODE`) VALUES
	('D2015122310', '软件开发', '院外', NULL, NULL, NULL, NULL, '省部级', '院外其他', '河南', NULL, NULL, NULL, NULL, NULL, NULL, '2015-12-23', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, 44, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('D201512239', '0000', '院外', NULL, NULL, NULL, NULL, '省部级', '院外其他', '河南', NULL, NULL, NULL, NULL, NULL, NULL, '2015-12-23', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, 25, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `s_project_approval_info` (
  ...
  KEY `id` (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='项目管理（立项）';

-- 正在导出表  db_saes.s_project_approval_info 的数据：1 rows
/*!40000 ALTER TABLE `s_project_approval_info` DISABLE KEYS */;
INSERT INTO `s_project_approval_info` (`ID`, `UNIQUE_CODE`, `RESEARCH_CLASS_ID`, `CREATE_TIME`, `PLAN_END_DATE`, `PROJECT_FEE`, `EXPECT_RESULT`, `SUO_CHECK_STATE`, `YUAN_CHECK_STATE`) VALUES
	(1, 'P2015121812', NULL, '2015-12-20 18:15:28', '2015-12-28 18:15:28', 0, NULL, 0, 0);
...
CREATE TABLE IF NOT EXISTS `s_project_basic_info` (
  ...
  `YUAN_CHECK_STATE` smallint(2) DEFAULT '0' COMMENT '院审核状态,0：不通过，1：通过',
  KEY `ID` (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='项目基本信息表（项目一览）';

-- 正在导出表  db_saes.s_project_basic_info 的数据：4 rows
...
INSERT INTO `s_project_basic_info` (`ID`, `UNIQUE_CODE`, `PROJECT_CODE`, `PROJECT_TYPE`, `PROJECT_NAME`, `CHARGER_NAME`, `UNIT_ID`, `APPLIER_ID`, `CREATE_TIME`, `SUO_CHECK_STATE`, `YUAN_CHECK_STATE`) VALUES
	(25, 'D2015122310', 'D2015122310', '院外其他', '软件开发', '王凯', 1, 1, '2016-01-03 09:31:20', 0, 0),
	(24, 'D2015122310', 'D2015122310', '院外其他', '软件开发', '王凯', 1, 1, '2016-01-03 09:31:01', 0, 0),
	(21, 'P2015121812', 'D2015122310', '院外其他', '软件开发', '王凯', 1, 1, '2015-12-30 12:17:25', 0, 0),
	(23, 'D2015122310', 'D2015122310', '院外其他', '软件开发', '王凯', 1, 1, '2015-12-30 16:46:53', 0, 0);
