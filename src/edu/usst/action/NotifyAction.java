...
public class NotifyAction {
    ...
    public void getListByPage() throws IOException {
        ...
        try {
            ...
            // 调用DAO进行分页查询 --- 结果数据
            lists = notifyDao.getListByPage(personId, getType, start, PageBean.NUMPERPAGE);
            bean.setKyxxList(lists);

            // 封装总记录条数
            int totalRecordNum = notifyDao.findTotalRecordNum(personId, getType);
