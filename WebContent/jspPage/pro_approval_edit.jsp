		...
		<div class="col-xs-12 mainPanel">
			<div class="panel panel-default">
				...
				<%
					...
					%>
				<form action="/SAES/pro_approval_edit1" method="post">
					<table class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td class="col-xs-1"><input type="text" name="PLAN_END_DATE" value="<%= approvalList.get("PLAN_END_DATE")%>" /></td>
							</tr>
							<tr>
								<td class="col-xs-1 active">项目经费</td>
								<td class="col-xs-1"><input type="text" name="PROJECT_FEE" value="<%= approvalList.get("PROJECT_FEE")%>"/>元</td>
								<td class="col-xs-1 active">预期成果形式</td>
								<td class="col-xs-1"><input type="text" name="EXPECT_RESULT" value="<%= approvalList.get("EXPECT_RESULT")%>"/></td>
							</tr>
							<tr>
					...
					<div>
					<input type="text"  style="display:none;" name="UNIQUE_CODE" value="<%= approvalList.get("UNIQUE_CODE")%>">
