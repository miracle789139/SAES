	...
	<%@ include file="footer.jsp" %>
		...
		function init() {
		    $(grid_selector).jqGrid({
		        url: '/SAES/manage/getUnitListAction', //获取数据的地址
		        ...
		        colModel: [
		            {
		                ...
		                formatoptions: {
		                    ...
		                    editOptions: {
		                        mtype: 'POST',
		                        url: '/SAES/manage/updateUnitAction',
		                        recreateForm: false,
		                        afterSave: jqgrid_row_opt
		                    }
		                }
		            },
		            {name: 'ID', index: 'ID', width: "5%",  hidden:true, editable:true, editrules: { edithidden: false }},
		            {name: 'UNIT_ID', index: 'UNIT_ID', width: "50%", editable: true, editoptions: {size: "15", maxlength: "15"}},
		            {name: 'NAME', index: 'NAME', width: "50%", editable: true, editoptions: {size: "15", maxlength: "15"}}
		        ...
		        //edit
		        editurl: '/SAES/manage/updateUnitAction',
		        prmNames: {
		            oper: "opt"
		        },
