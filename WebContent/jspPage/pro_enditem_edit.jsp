		...
		<div class="col-xs-12 mainPanel">
			<div class="panel panel-default">
				...
				<%
					...
					%>
				<form action="/SAES/pro_enditem_edit1" method="post">
					<table class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3" class="col-xs-1"><input type="text" name="FINISH_NOTE" value="<%= enditemList.get("FINISH_NOTE")%>"/></td>
							</tr>
							<tr>
					...
					<div>
					<input type="text"  style="display:none;" name="UNIQUE_CODE" value="<%= enditemList.get("UNIQUE_CODE")%>">
