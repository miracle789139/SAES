            ...
            <div class="panel-body">
                <ul class="list-inline">
                    ...
                    <li class=""><input type="button" class="btn btn-success " id="all"
                                        onclick="callBackPagination('notifyGetList','all',1,10);" value="查看"/></li>
                    <%
                        if (personId.equals("2")) {
                    %>
                    <li class=""><input type="button" class="btn " id="sender"
                                        onclick="callBackPagination('notifyGetList','sender',1,10);"
                                        value="我创建的"/></li>
...
<script>
    ...
    callBackPagination('notifyGetList',$("#opType").val(), 1, 10);//默认根据hidden赋值，这样可以在fancybox加载完后锁定当前导航页（还是不能做，工作量太大了，就先默认这样吧！）；类型，当前页，每页最大数
