		...
		<div class="col-xs-12 mainPanel">
			<div class="panel panel-default">
				...
				<div class="panel-heading">
		  		...
		  		<!-- Table -->
				<!-- Table -->
				<form action="/SAES/appmanaedit" method="post">
				<table class="table table-bordered table-hover">
      				<tbody>
      				    
				       <tr>
				           <input type="hidden" name="proId" id="proId" value="${insertInfo.applyId}"/>
				          <td colspan="2" class="col-xs-1">项目名称</td>
				          <td colspan="7" class="col-xs-1">
				              <input type="text" name="proName" value="${insertInfo.applyName}"/>
                          </td>
			          </tr>
				        <tr>
				          ...
				          <td colspan="7" class="col-xs-1">
				              <select id="prolocation" name="proLocation" >
				                  <option>${insertInfo.projectSourceUnit}</option>
				                  <option >北京</option>
				                  <option >上海</option>
				                  <option >河南</option>
				              </select> 
						...
						<tr>
				          ...
				          <td colspan="7" class="col-xs-1">
				              <select id="proClass"  name="proClass">
				                   <option>${insertInfo.projectClass}</option>
				                  <option>国家级</option>
				                  <option>省部级</option>
				                  <option>地区级</option>
				              </select> 
				        ...
				        <tr>
				          ...
				          <td colspan="7" class="col-xs-1">
				              <select id="proType"  name="proType">
				                 <option>${insertInfo.projectType}</option>
						...
						<tr>
				          <tr>
				          <input type="hidden" name="applierId" value="${insertInfo.applierID }"/>
				          <td colspan="2" class="col-xs-1">负责人姓名</td>
				          <td colspan="2" class="col-xs-1">
				              <input type="text" name="applierName" value="${insertInfo.applierName}"/>
                          </td>
				          <td width="8%" class="col-xs-1">性别</td>
				          <td width="8%" class="col-xs-1">
				              <input type="text" name="sex" value="${insertInfo.sex}"/>
				          </td>
				          <td width="8%" class="col-xs-1">身份证号码</td>
				          <td colspan="2" class="col-xs-1">
				              <input type="text" name="idCard" value="${insertInfo.idCard}"/>
				          </td>
				        </tr>
			            </tr>
						<tr>
				          ...
				          <td colspan="2" class="col-xs-1">
				              <input type="text" name="xingzheng" value="${insertInfo.duty}"/>
				          </td>
				          <td width="8%" class="col-xs-1">职称</td>
				          <td width="8%" class="col-xs-1">
				              <select name="zhicheng" >
				                  <option>${insertInfo.title}</option>
				                  <option >教授</option>
				                  <option >副教授</option>
				                  <option >讲师</option>
				              </select> 
				          ...
				          <td colspan="2" class="col-xs-1">
				              <input type="text" name="search" value="${insertInfo.researchField}"/>
				          </td>
			            </tr>
						<tr>
				          <td colspan="2" class="col-xs-1">所在单位</td>
				          <td colspan="3" class="col-xs-1">
				              <input type="text" name="unit" value="${insertInfo.school}"/>
				          </td>
				          <td colspan="2" class="col-xs-1">电子信箱</td>
				          <td colspan="2" class="col-xs-1">
				              <input type="text" name="email" value="${insertInfo.email}"/>
				          </td>
			            </tr>
			            <tr>
				          <td colspan="2" class="col-xs-1">通讯地址</td>
				          <td colspan="3" class="col-xs-1">
                              <input type="text" name="address" value="${insertInfo.adress}"/>
                          </td>
				          <td colspan="2" class="col-xs-1">邮政编码</td>
				          <td colspan="2" class="col-xs-1">
                              <input type="text" name="postal" value="${insertInfo.postalCode}"/>
                          </td>
			            </tr>
						 <tr>
				           <td colspan="2" class="col-xs-1">联系电话</td>
				          <td colspan="7" class="col-xs-1">（手机）<input type="text" name="mobile" value="${insertInfo.mobile}"/>（家庭）<input type="text" name="telHome" value="${insertInfo.telHome}"/>（单位）<input type="text" name="telUnit" value="${insertInfo.telOffice}"/></td>
			          </tr>
